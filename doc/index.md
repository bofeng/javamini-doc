...
* If you download the JDK from above, you are probably using JDK 11. OYOclass' Java Editor also uses JDK 11. If you are using a different version of JDK, like JDK 8 or JDK 7, there aren't too many differences. [Click here](https://docs.oracle.com/javase/8/docs/api/) for the documentation for JDK 8, and [Here](https://docs.oracle.com/javase/7/docs/api/) for JDK 7.
